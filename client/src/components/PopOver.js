 ...
 const popover = (
  ...
  const PopOver = ({product}) => (
    <OverlayTrigger trigger="hover" placement="right" overlay={popover}>
        <Row>
        <Col >
        <i className= { product.isVegan === true ? 'fa-solid fa-seedling fa-lg px-1': ''}></i> 
        <i className= { product.isVegeterian === true ? 'fa-solid fa-leaf fa-lg px-1': ''}></i> 
        <i className= { product.isKeto === true ? 'fa-solid fa-k fa-lg px-1': ''}></i> 
        <i className= { product.isOrganic === true ? 'fa-solid fa-o fa-lg px-1': ''}></i> 
        </Col>
        </Row>
